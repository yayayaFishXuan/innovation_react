...
import { HeartOutlined, HeartTwoTone, LikeOutlined, LikeTwoTone, DollarOutlined,CommentOutlined, EditTwoTone, ExclamationCircleOutlined, EllipsisOutlined, FormOutlined, DeleteOutlined, DeleteTwoTone, UserOutlined, ShareAltOutlined } from '@ant-design/icons';
            ...
            <Card className="box-card">
                <div className="card-header">
                    ...
                    <div className="detail">
                        ...
                        <span className="content">{postInfo.content}</span>
                        <span style={{color:"#1AF052"}}>售價{postInfo.price}</span>
