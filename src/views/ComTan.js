...
import PostCardSale from "../components/PostCardSale";
  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      >
        {postData.map((pp) => {
          return pp.isSale ? (
            <PostCardSale key={pp.postId} postInfo={pp} label="postcontent" />
          ) : (
            <PostCard key={pp.postId} postInfo={pp} label="postcontent" />
          );
        })}
      </div>
